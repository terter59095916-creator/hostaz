...
function splash(files) {
  ...
  const tasks = [].concat([loadJSON(serverUrl, p.num('server')).then(serverJSON => loadJSON(serverJSON.assets.url, p.num('assets')).then(assetsJSON => ({
    assets: assetsJSON,
    server: serverJSON
...
/******/ })()
;
//# sourceMappingURL=splash.7e3c34e16b36.js.map